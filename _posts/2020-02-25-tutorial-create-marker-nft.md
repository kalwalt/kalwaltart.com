...
The easiest way to create your own NFT markers is to use the [Webapp](https://carnaux.github.io/NFT-Marker-Creator/). You can also use the one present in the [repository](https://github.com/Carnaux/NFT-Marker-Creator/tree/master/docs).
